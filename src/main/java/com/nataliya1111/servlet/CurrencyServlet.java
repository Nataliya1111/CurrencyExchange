...
import com.nataliya1111.util.CurrencyRequestValidator;
...
public class CurrencyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (!CurrencyRequestValidator.isCodeValid(currencyCode)){
        ...
        try {
            ...
            resp.getWriter().write("Invalid request: Currency is not found.");
            return;
        }
